package org.jeasy.batch.tutorials.advanced.quartz;
...
public class EasyBatchJob implements org.quartz.Job {
     ...
     * The job instance.
     */
    private org.jeasy.batch.core.job.Job easyBatchJob;
     ...
     */
    public EasyBatchJob(final org.jeasy.batch.core.job.Job easyBatchJob) {
